const { useState, useEffect, useMemo, useRef, useCallback } = React;
    ...
    const InfinityParticles = ({ enabled, isDarkMode }) => {
      ...
      useEffect(() => {
        ...
        const particleCount = isDarkMode ? 35 : 25;
        const baseOpacity = isDarkMode ? 0.4 : 0.25;
        const baseSize = isDarkMode ? 2.5 : 2;
        ...
        const initParticles = () => {
          ...
          for (let i = 0; i < particleCount; i++) {
            ...
            particlesRef.current.push({
              ...
              speedY: -0.2 - Math.random() * 0.4, // drift upward
        ...
        const animate = () => {
          ...
          particlesRef.current.forEach((p) => {
            ...
            gradient.addColorStop(0.4, `rgba(${p.color.r}, ${p.color.g}, ${p.color.b}, ${pulseOpacity * 0.4})`);
