const { useState, useEffect, useMemo, useRef, useCallback } = React;
    ...
    // ========== INFINITY PARTICLES ==========
    const InfinityParticles = ({ enabled, isDarkMode }) => {
      ...
      useEffect(() => {
        ...
        // Infinity spectrum colors
        const darkColors = [
          { r: 247, g: 166, b: 255 }, // pink
          { r: 156, g: 107, b: 255 }, // violet
          { r: 111, g: 234, b: 255 }, // cyan
          { r: 201, g: 134, b: 255 }, // soft violet
          { r: 76, g: 217, b: 255 },  // bright cyan
        ];
        ...
        const lightColors = [
          ...
          { r: 156, g: 107, b: 255 }, // violet  
          { r: 111, g: 234, b: 255 }, // cyan
          { r: 229, g: 216, b: 255 }, // very soft violet
          { r: 209, g: 246, b: 255 }, // very soft cyan
        ];

        const colors = isDarkMode ? darkColors : lightColors;
        const particleCount = isDarkMode ? 50 : 30;
        const baseOpacity = isDarkMode ? 0.7 : 0.35;
        const baseSize = isDarkMode ? 3 : 2.5;
        ...
        const initParticles = () => {
          ...
          for (let i = 0; i < particleCount; i++) {
            ...
            particlesRef.current.push({
              ...
              speedY: -0.15 - Math.random() * 0.35, // drift upward slower
        ...
        const animate = () => {
          ...
          particlesRef.current.forEach((p) => {
            ...
            gradient.addColorStop(0.3, `rgba(${p.color.r}, ${p.color.g}, ${p.color.b}, ${pulseOpacity * 0.5})`);
            gradient.addColorStop(0.6, `rgba(${p.color.r}, ${p.color.g}, ${p.color.b}, ${pulseOpacity * 0.15})`);
      ...
      return (
        <canvas
          ref={canvasRef}
          className="infinity-particles-canvas"
          style={{
            position: 'fixed',
            top: 0,
            left: 0,
